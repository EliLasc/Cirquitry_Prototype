...
void ACirquitry_GameplayManager::StartCasting(AActor* TargetActor)
{
	
}

void ACirquitry_GameplayManager::ApplyEffectToTarget(AActor* TargetActor, TSubclassOf<UGameplayEffect> GameplayEffectClass)
{
